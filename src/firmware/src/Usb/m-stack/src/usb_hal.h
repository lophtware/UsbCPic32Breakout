...
#define CLEAR_USB_TOKEN_IF()     SFR_USB_INTERRUPT_FLAGS = 0x08
#define CLEAR_USB_SOF_IF()       SFR_USB_INTERRUPT_FLAGS = 0x4
#define CLEAR_USB_IF()           SFR_USB_IF = 0
#else
#define CLEAR_ALL_USB_IF()       do { U1IRCLR = 0xff; U1EIRCLR = 0xff; } while(0)
#define CLEAR_USB_RESET_IF()     U1IRCLR = 0x1
#define CLEAR_USB_STALL_IF()     U1IRCLR = 0x80
#define CLEAR_USB_TOKEN_IF()     U1IRCLR = 0x08
#define CLEAR_USB_SOF_IF()       U1IRCLR = 0x4
#define CLEAR_USB_IF()           IFS0CLR = _IFS0_USBIF_MASK
#endif
...
#define XC8_BUFFER_ADDR_TAG __attribute__((aligned(4), coherent))
