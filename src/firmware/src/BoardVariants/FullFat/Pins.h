#ifndef __LOPHTWARE_USBCPIC32BREAKOUT_FIRMWARE_BOARDVARIANTS_FULLFAT_PINS_H
#define __LOPHTWARE_USBCPIC32BREAKOUT_FIRMWARE_BOARDVARIANTS_FULLFAT_PINS_H
...
#define CONFIGURABLE_RPOR3_MASK 0
